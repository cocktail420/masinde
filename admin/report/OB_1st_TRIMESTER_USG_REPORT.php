...
<p align="left" style="padding-left:5%;">3.	At 08:16 AM (UTC+1), on <?php if($lmp!=''){ echo date('d/m/Y',strtotime($lmp));} ?>, Mr/Ms Front office, Vincent Ochiengs, commenced the acquisition/extraction of Mr/Ms <?php echo $patient_name; ?>s App,  using APP 8.0.0.29.   <br/></p>
